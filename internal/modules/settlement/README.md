...
VietQR payloads are encoded locally by `internal/platform/vietqr`. Proof images use private Cloudinary assets and five minute signed URLs. River runs hourly reminder and stalled confirmation scans. It also removes expired idempotency records and retries failed proof cleanup.
